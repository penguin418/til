package com.github.penguin418.practice02_expect_in_handler;

import com.github.penguin418.model.Todo;
import com.github.penguin418.practice02_expect_in_handler.rest.TodoApis;
...
@Slf4j
public class ExpectWebClient extends AbstractVerticle {
    @Override
    ...
    public static void main(String[] args) {
        Vertx.vertx().deployVerticle(new ExpectWebClient());
    }
}
